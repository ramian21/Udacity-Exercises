...
//  COMPLETED (8) Provide an implementation for the query method
    ...
    public Cursor query(@NonNull Uri uri, String[] projection, String selection,
        ...
        switch (match) {
            case CODE_WEATHER:
                retCursor = db.query(WeatherContract.WeatherEntry.TABLE_NAME, null, null, null, null, null, null);
                break;
            case CODE_WEATHER_WITH_DATE:
                String id = uri.getPathSegments().get(1);
                retCursor = db.query(WeatherContract.WeatherEntry.TABLE_NAME, null, "_id=?", new String[]{id}, null, null, null, null);
                break;
            default:
