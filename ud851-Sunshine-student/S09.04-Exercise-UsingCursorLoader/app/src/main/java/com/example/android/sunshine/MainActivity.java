...
//      COMPLETED (20) Implement LoaderCallbacks<Cursor> instead of String[]
    ...
    private final String[] COLUMN_NAMES = {WeatherContract.WeatherEntry.COLUMN_DATE, WeatherContract.WeatherEntry.COLUMN_WEATHER_ID, WeatherContract.WeatherEntry.COLUMN_MAX_TEMP, WeatherContract.WeatherEntry.COLUMN_MIN_TEMP};
...
//          COMPLETED (22) If the loader requested is our forecast loader, return the appropriate CursorLoader
        if (id == ID_FORECAST_LOADER) {
            ...
            return new CursorLoader(this, WeatherContract.WeatherEntry.CONTENT_URI, null, selection, null, sortOrder);
        }
        throw new RuntimeException("Loadder not implemented" + id);
    }
