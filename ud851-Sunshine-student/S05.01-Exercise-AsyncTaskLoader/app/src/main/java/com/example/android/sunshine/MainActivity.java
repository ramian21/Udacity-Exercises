...
public class MainActivity extends AppCompatActivity implements ForecastAdapterOnClickHandler, LoaderManager.LoaderCallbacks<String> {
    ...
    private static final String SEARCH_URL_KEY = "weatherSearch";
    private static final int WEATHER_SEARCH_LOADER = 012;
    ...
    private void loadWeatherData() {
        ...
        queryBundle.putString(SEARCH_URL_KEY, weatherDataUrl.toString());
    ...
    public Loader<String> onCreateLoader(int id, final Bundle args) {
        return new AsyncTaskLoader<String>(this) {
            ...
            public String loadInBackground() {
                String weatherUrlString = args.getString(SEARCH_URL_KEY);

                if (weatherUrlString == null || weatherUrlString.equals("")) {
                    return null;
                }
                URL url = NetworkUtils.buildUrl(weatherUrlString);
                try {
                    String weatherResults = NetworkUtils.getResponseFromHttpUrl(url);
                    //String[] weatherResultsJson = OpenWeatherJsonUtils.getSimpleWeatherStringsFromJson(MainActivity.this, weatherResults);
