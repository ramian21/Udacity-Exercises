...
public class TaskContentProvider extends ContentProvider {
    ...
    private static final int TASK_DIRECTORY = 100;
    private static final int TASK_INDIVIDUAL = 101;
    ...
    private static UriMatcher buildUriMatcher() {
        ...
        uriMatcher.addURI(TaskContract.AUTHORITY, TaskContract.PATH_TASKS + "/#", TASK_INDIVIDUAL);
    }
