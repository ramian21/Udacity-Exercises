...
public class NotificationUtils {
    ...
    private static final int PENDING_INTENT_ID = 999;
    private static final int NOTIFICATION_CHANNEL_NUMBER = 990;
    private static final String NOTIFICATION_CHANNEL_ID = "water_reminder";
    ...
    public static void remindUserBecauseCharging(Context context) {
        ...
        notificationManager.notify(NOTIFICATION_CHANNEL_NUMBER, notificationBuilder.build());
    }
