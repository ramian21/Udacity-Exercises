...
//        String floatKey = getString(R.string.pref_size_key);
//        Float floatVal = Float.parseFloat(getString(R.string.pref_size_value));
//        mVisualizerView.setMinSizeScale(sharedPreferences.getFloat(floatKey, floatVal));
